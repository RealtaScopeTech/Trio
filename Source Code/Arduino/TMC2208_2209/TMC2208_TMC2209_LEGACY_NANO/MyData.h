...
String V_STEPPER_DRIVER = "TMC_2208_2209";
...
STEPPING_MODE[0].M1_STATE = 1; STEPPING_MODE[1].M2_STATE = 0; // High Low  1/2 step
STEPPING_MODE[1].M1_STATE = 0; STEPPING_MODE[2].M2_STATE = 1; // Low  High 1/4 step
STEPPING_MODE[2].M1_STATE = 0; STEPPING_MODE[3].M2_STATE = 0; // Low  Low  1/8 step
STEPPING_MODE[3].M1_STATE = 1; STEPPING_MODE[3].M2_STATE = 1; // High High 1/16 step
}
