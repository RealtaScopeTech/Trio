...
; Generated by WillMoran on 23/01/2021 (UTC)
;
[Setup]
AppID={{106ec78f-4823-495c-8187-99a6f163bf13}
AppName=ASCOM RealtaTrio Focuser Driver
AppVerName=ASCOM RealtaTrio Focuser Driver 1.0.1
AppVersion=1.0.1
AppPublisher=RealtaScopeTech <RealtaScopeTech@gmail.com>
AppPublisherURL=mailto:RealtaScopeTech@gmail.com
...
OutputDir="."
OutputBaseFilename="RealtaTrio Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Focuser\RealtaTrio"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Focuser\RealtaTrio"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\Users\willi\source\repos\ASCOM.RealtaTrio.Focuser\bin\Release\ASCOM.RealtaTrio.Focuser.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "C:\Users\willi\source\repos\ASCOM.RealtaTrio.Focuser\README.txt"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.RealtaTrio.Focuser.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.RealtaTrio.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.RealtaTrio.Focuser.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.RealtaTrio.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.RealtaTrio.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
