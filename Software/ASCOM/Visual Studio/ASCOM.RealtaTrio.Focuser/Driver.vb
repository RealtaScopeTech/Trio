...
Public Class Focuser
    ...
    Dim vMyNetworkServer As NewtorkServer
    ...
    Public Sub New()
        ...
        vMyNetworkServer = New NewtorkServer

        'TODO: Implement your additional construction here
        If vIsListening = False Then
            vMyNetworkServer.ListenerThread.Start()
            vMyNetworkServer.Initialise()
        End If

        vMyNetworkServer.GetGonnected()
        vMyNetworkServer.GetFocuserSettings()
...
#Region "IFocuser Implementation"
    ...
    Public Sub Move(Position As Integer) Implements IFocuserV3.Move
        ...
        vMyNetworkServer.MoveFocuser(Position)
    ...
    Public ReadOnly Property Temperature() As Double Implements IFocuserV3.Temperature
        Get
            TL.LogMessage("Temperature Get", vTemp.ToString())
            vMyNetworkServer.GetTemp()
            Return vTemp
        End Get
    End Property
